function [nickel_logical quarter_logical] = identify_nq(nq_coin_radii,nq_radii);
rad2thresh = nq_radii;
...
% end
max_radius = max(x_diam2thresh);
radius_threshold = graythresh(rad2thresh/max_radius);
quarter_logical = (rad2thresh/max_radius)>radius_threshold;
nickel_logical = (rad2thresh/max_radius)<radius_threshold;
