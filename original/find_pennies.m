...
% Finds pennies in image using hue and saturation values
...
% corresponds to a coin (no clutter or overlapping)

% iterator - array of labels of all coins in thresholded and labeled image

% OUTPUTS:

% penny_logical - logical array where index i is true if region with label
% equal to iterator(i) is a penny
